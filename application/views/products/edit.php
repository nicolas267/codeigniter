            ...
            <form role="form" action="update" method="post">
              <div class="box-body">
                <div class="form-group">
                  <label for="title">actualizar nombre del producto</label>
                  <input type="text" class="form-control" id="title" name="title" placeholder="titulo del producto">
                </div>
                <div class="form-group">
                  <label for="description">actualizar descripción del producto</label>
                  <input type="text" class="form-control" id="description" name="description" placeholder="titulo del producto">
                </div>
                <div class="form-group">
                  <label for="exampleInputPassword1">actualizar categoria del producto</label><br>
                  <select class="form-control" name="category">
                    <option></option>
                    <option value="1">inmuebles</option>
                    <option value="2">muebles</option>
                  </select>
                  <input type="hidden" name="idproduct" value="<?php echo $_GET['productId']; ?>">
                </div>
              </div>
              <!-- /.box-body -->
