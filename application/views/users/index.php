            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
                      <button id="editar" class="btn btn-primary editar" accesskey="<?php echo $user->user_id?>">editar</button>
                      <button id="borrar" class="btn btn-danger borrar" accesskey="<?php echo $user->user_id?>">borrar</button>
                  </td>
                </tr>
                <?php } ?>
              ...
              <a href="create" class="btn btn-info">Agregar usuario</a>
            </div>
            <!-- /.box-body -->
          </div>
          <!-- /.box -->
