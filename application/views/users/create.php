            ...
            <form role="form" action="store" method="post">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="title" name="name" placeholder="nombre">
                </div>
            <div class="box-body">
                <div class="form-group">
                  <label for="title">apellido</label>
                  <input type="text" class="form-control" id="title" name="lastname" placeholder="apellido">
                </div>
              </div>
            <div class="box-body">
                <div class="form-group">
                  <label for="title">email</label>
                  <input type="email" class="form-control" id="title" name="email" placeholder="email">
                </div>
              </div>
              <div class="box-body">
                <div class="form-group">
                  <label for="title">password</label>
                  <input type="password" class="form-control" id="title" name="password" placeholder="password">
                </div>
              </div>
