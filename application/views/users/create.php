      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form action="http://localhost/codeigniter/index.php/Users/store" method="post"  id="formulario_ajax" enctype= multipart/form-data>
              <div class="box-body">
                <div class="form-group">
                   <label for="userfile">
                      <img src="<?php echo base_url().'assets/camera.jpg';?>" id="preview" class="img-circle"alt="Click aquí para subir tu foto" title ="Click aquí para subir tu foto" height="200px" width="200px"> 
                   </label>
