            ...
            <form role="form" action="update" method="post">
              <div class="box-body">
                <div class="form-group">
                  <label for="title">actualizar categoria</label>
                  <input type="text" class="form-control" id="title" name="category" placeholder="titulo del categoria">
                </div>
                  <input type="hidden" name="idcategory" value="<?php echo $_GET['categoryId']; ?>">
                </div>
              </div>
              <!-- /.box-body -->
