            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
                      <button id="editar" class="btn btn-primary editar" accesskey="<?php echo $category->category_id?>">editar</button>
                      <button id="borrar" class="btn btn-danger borrar" accesskey="<?php echo $category->category_id?>">borrar</button>
                  </td>
                </tr>
                <?php } ?>
              ...
              <a href="create" class="btn btn-info">Agregar categoria</a>
            </div>
            <!-- /.box-body -->
          </div>
          <!-- /.box -->
...
<script type="text/javascript">
  $(document).ready(function() {
    $(".editar").click(function(e) {
     var product = e.target.accessKey;

      $(window.location).attr('href','edit?categoryId='+product+''); 
    ...
    $(".borrar").click(function(e){
      ...
      $(window.location).attr('href','destroy?categoryId='+product+'');
