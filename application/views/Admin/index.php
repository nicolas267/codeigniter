    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="sidebar-menu">
           <a href="<?php echo site_url('Welcome/editar'); ?>">
        ...
        <li class="sidebar-menu">
           <a href="<?php echo site_url('Welcome/eliminar'); ?>">
        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div class="box box-success">
            ...
            <div class="box-body chat" id="chat-box">
              ...
              <!-- chat item -->
              <div class="item">
                <img src="<?php echo base_url(); ?>assets/dist/img/user8-128x128.jpg" alt="user image" class="offline">
